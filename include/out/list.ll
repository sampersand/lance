...
define %struct.list* @concat_lists(%struct.list* nocapture readonly %0, %struct.list* nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %27 = load i64*, i64** %22, align 8, !tbaa !10
...
25:                                               ; preds = %20, %25
  ...
  %27 = phi i64* [ %34, %25 ], [ %21, %20 ]
  %28 = phi i64 [ %29, %25 ], [ %1, %20 ]
  %29 = add nsw i64 %28, -1
  %30 = bitcast i64* %27 to i8*
  %31 = load i8*, i8** %18, align 8, !tbaa !10
  %32 = shl i64 %26, 3
  ...
  %35 = icmp eq i64 %29, 0
  br i1 %35, label %23, label %25, !llvm.loop !18
}
...
13:                                               ; preds = %9
  ...
  %16 = shl nsw i64 %5, 1
  store i64 %16, i64* %10, align 8, !tbaa !17
  %17 = shl i64 %5, 4
  %18 = tail call i8* @xrealloc(i8* %15, i64 %17) #4
  store i8* %18, i8** %14, align 8, !tbaa !10
...
26:                                               ; preds = %31, %20
  %27 = load i64, i64* %2, align 8, !tbaa !20
...
31:                                               ; preds = %20, %31
  ...
  br i1 %37, label %31, label %26, !llvm.loop !21
...
9:                                                ; preds = %3
  ...
  store i64 %13, i64* %1, align 8, !tbaa !20
...
11:                                               ; preds = %2
  ...
  %14 = shl nsw i64 %4, 1
  store i64 %14, i64* %3, align 8, !tbaa !17
  %15 = shl i64 %4, 4
  %16 = tail call i8* @xrealloc(i8* %13, i64 %15) #4
  store i8* %16, i8** %12, align 8, !tbaa !10
  %17 = bitcast i8* %16 to i64*
  %18 = load i64, i64* %5, align 8, !tbaa !16
  br label %19
...
9:                                                ; preds = %6, %2
  ...
  %13 = add nsw i64 %10, -1
  store i64 %13, i64* %3, align 8, !tbaa !16
...
attributes #2 = { nofree nounwind ssp uwtable "frame-pointer"="non-leaf" "min-legal-vector-width"="0" "no-trapping-math"="true" "probe-stack"="__chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+crypto,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+sm4,+v8.5a,+zcm,+zcz" }
...
!10 = !{!11, !12, i64 0}
!11 = !{!"", !12, i64 0, !15, i64 8, !15, i64 16}
