...
declare %num @fn.user.count_char_occurances(%struct.builtin.str*, %struct.builtin.str*)
declare void @fn.user.abort(%struct.builtin.str*)

; String declarations
@string.-3516812292695976188.str = private unnamed_addr constant [1 x i8] c":", align 1
@string.-3516812292695976188 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @string.-3516812292695976188.str, i32 0, i32 0), i64 1 }, align 8

@string.-2465071029234232393.str = private unnamed_addr constant [0 x i8] c"", align 1
@string.-2465071029234232393 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([0 x i8], [0 x i8]* @string.-2465071029234232393.str, i32 0, i32 0), i64 0 }, align 8

@string.-3286992436274700316.str = private unnamed_addr constant [18 x i8] c"advancing past EOF", align 1
@string.-3286992436274700316 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([18 x i8], [18 x i8]* @string.-3286992436274700316.str, i32 0, i32 0), i64 18 }, align 8

@string.-261249867576863750.str = private unnamed_addr constant [1 x i8] c"\0A", align 1
@string.-261249867576863750 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @string.-261249867576863750.str, i32 0, i32 0), i64 1 }, align 8

@string.-299152198582285004.str = private unnamed_addr constant [5 x i8] c" \0A\09\0D\0C", align 1
@string.-299152198582285004 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([5 x i8], [5 x i8]* @string.-299152198582285004.str, i32 0, i32 0), i64 5 }, align 8

@string.3908548717344525511.str = private unnamed_addr constant [2 x i8] c"/*", align 1
@string.3908548717344525511 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @string.3908548717344525511.str, i32 0, i32 0), i64 2 }, align 8

@string.3055383678529570278.str = private unnamed_addr constant [41 x i8] c"Missing closing `*/`. Comment started at ", align 1
@string.3055383678529570278 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([41 x i8], [41 x i8]* @string.3055383678529570278.str, i32 0, i32 0), i64 41 }, align 8

@string.2181589587734948890.str = private unnamed_addr constant [2 x i8] c"*/", align 1
@string.2181589587734948890 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @string.2181589587734948890.str, i32 0, i32 0), i64 2 }, align 8

@string.3377538327882136676.str = private unnamed_addr constant [2 x i8] c"//", align 1
@string.3377538327882136676 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @string.3377538327882136676.str, i32 0, i32 0), i64 2 }, align 8

@string.-4311935457168022537.str = private unnamed_addr constant [2 x i8] c": ", align 1
@string.-4311935457168022537 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @string.-4311935457168022537.str, i32 0, i32 0), i64 2 }, align 8

@string.-3374061463322827273.str = private unnamed_addr constant [1 x i8] c"0", align 1
@string.-3374061463322827273 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @string.-3374061463322827273.str, i32 0, i32 0), i64 1 }, align 8

@string.-136658502058251332.str = private unnamed_addr constant [1 x i8] c"9", align 1
@string.-136658502058251332 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @string.-136658502058251332.str, i32 0, i32 0), i64 1 }, align 8

@string.-3702558588014077380.str = private unnamed_addr constant [39 x i8] c"invalid suffix for number encountered: ", align 1
@string.-3702558588014077380 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([39 x i8], [39 x i8]* @string.-3702558588014077380.str, i32 0, i32 0), i64 39 }, align 8

@string.-2457062555048857900.str = private unnamed_addr constant [4 x i8] c"oops", align 1
@string.-2457062555048857900 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @string.-2457062555048857900.str, i32 0, i32 0), i64 4 }, align 8
...
define %struct.user.StreamPos* @fn.user.Lexer_pos(%struct.user.Lexer* %0) {
...
define %struct.builtin.str* @fn.user.StreamPos_tostr(%struct.user.StreamPos* %0) {
  ...
  store %struct.builtin.str* @string.-3516812292695976188, %struct.builtin.str** %4, align 8
  %5 = load %struct.builtin.str*, %struct.builtin.str** %4, align 8
...
define internal %bool @fn.user.is_eof(%struct.user.Lexer* %0) {
...
define internal %struct.builtin.str* @fn.user.peek(%struct.user.Lexer* %0) {
  %2 = alloca %bool (%struct.user.Lexer*)*, align 8
  store %bool (%struct.user.Lexer*)* @fn.user.is_eof, %bool (%struct.user.Lexer*)** %2, align 8
  ...
  store %struct.builtin.str* @string.-2465071029234232393, %struct.builtin.str** %7, align 8
...
define internal void @fn.user.advance(%struct.user.Lexer* %0) {
  %2 = alloca %bool (%struct.user.Lexer*)*, align 8
  store %bool (%struct.user.Lexer*)* @fn.user.is_eof, %bool (%struct.user.Lexer*)** %2, align 8
  %3 = load %bool (%struct.user.Lexer*)*, %bool (%struct.user.Lexer*)** %2, align 8
  %4 = call %bool %3(%struct.user.Lexer* %0)
  ...
  store %struct.builtin.str* @string.-3286992436274700316, %struct.builtin.str** %9, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %12, align 8
  ...
  store %struct.builtin.str* @string.-261249867576863750, %struct.builtin.str** %15, align 8
...
define internal %struct.builtin.str* @fn.user.peek_advance(%struct.user.Lexer* %0) {
  %2 = alloca %struct.builtin.str*, align 8
  %3 = alloca %struct.builtin.str* (%struct.user.Lexer*)*, align 8
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %3, align 8
  ...
  store void (%struct.user.Lexer*)* @fn.user.advance, void (%struct.user.Lexer*)** %6, align 8
...
define internal %bool @fn.user.take_if_starts_with(%struct.user.Lexer* %0, %struct.builtin.str* %1) {
  %3 = alloca %num, align 8
  ...
  store %num (%struct.builtin.str*, %struct.builtin.str*)* @fn.user.count_char_occurances, %num (%struct.builtin.str*, %struct.builtin.str*)** %37, align 8
  ...
  store %struct.builtin.str* @string.-261249867576863750, %struct.builtin.str** %39, align 8
...
define internal %bool @fn.user.iswhitespace(%struct.builtin.str* %0) {
  ...
  %4 = alloca %struct.builtin.str*, align 8
  store %struct.builtin.str* @string.-299152198582285004, %struct.builtin.str** %4, align 8
  %5 = load %struct.builtin.str*, %struct.builtin.str** %4, align 8
  %6 = call %bool %3(%struct.builtin.str* %5, %struct.builtin.str* %0)
  ret %bool %6
}

define internal void @fn.user.strip(%struct.user.Lexer* %0) {
  br label %2
  2:
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %10, align 8
  ...
  store void (%struct.user.Lexer*)* @fn.user.advance, void (%struct.user.Lexer*)** %16, align 8
  ...
  store %bool (%struct.user.Lexer*, %struct.builtin.str*)* @fn.user.take_if_starts_with, %bool (%struct.user.Lexer*, %struct.builtin.str*)** %19, align 8
  ...
  store %struct.builtin.str* @string.3908548717344525511, %struct.builtin.str** %21, align 8
  ...
  store %struct.user.StreamPos* (%struct.user.Lexer*)* @fn.user.Lexer_pos, %struct.user.StreamPos* (%struct.user.Lexer*)** %27, align 8
  ...
  store %bool (%struct.user.Lexer*)* @fn.user.is_eof, %bool (%struct.user.Lexer*)** %41, align 8
  ...
  store %struct.builtin.str* @string.3055383678529570278, %struct.builtin.str** %48, align 8
  %49 = load %struct.builtin.str*, %struct.builtin.str** %48, align 8
  %50 = alloca %struct.builtin.str* (%struct.user.StreamPos*)*, align 8
  store %struct.builtin.str* (%struct.user.StreamPos*)* @fn.user.StreamPos_tostr, %struct.builtin.str* (%struct.user.StreamPos*)** %50, align 8
  ...
  store %bool (%struct.user.Lexer*, %struct.builtin.str*)* @fn.user.take_if_starts_with, %bool (%struct.user.Lexer*, %struct.builtin.str*)** %56, align 8
  ...
  store %struct.builtin.str* @string.3908548717344525511, %struct.builtin.str** %58, align 8
  ...
  store %bool (%struct.user.Lexer*, %struct.builtin.str*)* @fn.user.take_if_starts_with, %bool (%struct.user.Lexer*, %struct.builtin.str*)** %68, align 8
  ...
  store %struct.builtin.str* @string.2181589587734948890, %struct.builtin.str** %70, align 8
  ...
  store void (%struct.user.Lexer*)* @fn.user.advance, void (%struct.user.Lexer*)** %80, align 8
  ...
  store %bool (%struct.user.Lexer*, %struct.builtin.str*)* @fn.user.take_if_starts_with, %bool (%struct.user.Lexer*, %struct.builtin.str*)** %86, align 8
  ...
  store %struct.builtin.str* @string.3377538327882136676, %struct.builtin.str** %88, align 8
  ...
  store %bool (%struct.user.Lexer*)* @fn.user.is_eof, %bool (%struct.user.Lexer*)** %95, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %102, align 8
  ...
  store %struct.builtin.str* @string.-261249867576863750, %struct.builtin.str** %105, align 8
  ...
  store void (%struct.user.Lexer*)* @fn.user.advance, void (%struct.user.Lexer*)** %117, align 8
...
define void @fn.user.StreamPos_Abort(%struct.user.StreamPos* %0, %struct.builtin.str* %1) {
  ...
  store %struct.builtin.str* (%struct.user.StreamPos*)* @fn.user.StreamPos_tostr, %struct.builtin.str* (%struct.user.StreamPos*)** %5, align 8
  ...
  store %struct.builtin.str* @string.-4311935457168022537, %struct.builtin.str** %8, align 8
...
define void @fn.user.Lexer_abort(%struct.user.Lexer* %0, %struct.builtin.str* %1) {
  %3 = alloca void (%struct.user.StreamPos*, %struct.builtin.str*)*, align 8
  store void (%struct.user.StreamPos*, %struct.builtin.str*)* @fn.user.StreamPos_Abort, void (%struct.user.StreamPos*, %struct.builtin.str*)** %3, align 8
  ...
  store %struct.user.StreamPos* (%struct.user.Lexer*)* @fn.user.Lexer_pos, %struct.user.StreamPos* (%struct.user.Lexer*)** %5, align 8
...
define internal %bool @fn.user.isdigit(%struct.builtin.str* %0) {
  ...
  store %struct.builtin.str* @string.-3374061463322827273, %struct.builtin.str** %3, align 8
  ...
  store %struct.builtin.str* @string.-136658502058251332, %struct.builtin.str** %10, align 8
...
define %bool @fn.user.isalnum(%struct.builtin.str* %0) {
...
define %struct.user.Token* @fn.user.new_token(%struct.user.Lexer* %0, %struct.user.enum.TokenKind* %1) {
  %3 = alloca %struct.user.StreamPos* (%struct.user.Lexer*)*, align 8
  store %struct.user.StreamPos* (%struct.user.Lexer*)* @fn.user.Lexer_pos, %struct.user.StreamPos* (%struct.user.Lexer*)** %3, align 8
...
define %struct.user.Token* @fn.user.parse_number(%struct.user.Lexer* %0) {
  %2 = alloca %struct.builtin.str*, align 8
  %3 = alloca %struct.builtin.str*, align 8
  store %struct.builtin.str* @string.-2465071029234232393, %struct.builtin.str** %3, align 8
  %4 = load %struct.builtin.str*, %struct.builtin.str** %3, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %8, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %15, align 8
  ...
  store void (%struct.user.Lexer*)* @fn.user.advance, void (%struct.user.Lexer*)** %19, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %24, align 8
  ...
  store void (%struct.user.Lexer*, %struct.builtin.str*)* @fn.user.Lexer_abort, void (%struct.user.Lexer*, %struct.builtin.str*)** %30, align 8
  ...
  store %struct.builtin.str* @string.-3702558588014077380, %struct.builtin.str** %32, align 8
  %33 = load %struct.builtin.str*, %struct.builtin.str** %32, align 8
  %34 = alloca %struct.builtin.str* (%struct.user.Lexer*)*, align 8
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %34, align 8
  ...
  store %struct.user.Token* (%struct.user.Lexer*, %struct.user.enum.TokenKind*)* @fn.user.new_token, %struct.user.Token* (%struct.user.Lexer*, %struct.user.enum.TokenKind*)** %56, align 8
...
define %struct.user.Token* @fn.user.Lexer_next(%struct.user.Lexer* %0) {
  %2 = alloca void (%struct.user.Lexer*)*, align 8
  store void (%struct.user.Lexer*)* @fn.user.strip, void (%struct.user.Lexer*)** %2, align 8
  ...
  store %struct.builtin.str* (%struct.user.Lexer*)* @fn.user.peek, %struct.builtin.str* (%struct.user.Lexer*)** %5, align 8
  ...
  store %struct.user.Token* (%struct.user.Lexer*)* @fn.user.parse_number, %struct.user.Token* (%struct.user.Lexer*)** %14, align 8
  ...
  %21 = alloca %struct.builtin.str*, align 8
  store %struct.builtin.str* @string.-2457062555048857900, %struct.builtin.str** %21, align 8
  %22 = load %struct.builtin.str*, %struct.builtin.str** %21, align 8
