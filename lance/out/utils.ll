...
; String declarations
@string.-3389732028997062709.str = private unnamed_addr constant [7 x i8] c"error: ", align 1
@string.-3389732028997062709 = private local_unnamed_addr global %struct.builtin.str { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @string.-3389732028997062709.str, i32 0, i32 0), i64 7 }, align 8
...
; Functions
define %num @fn.user.count_char_occurrences(%struct.builtin.str* %0, %struct.builtin.str* %1) {
...
define %bool @fn.user.string_contains(%struct.builtin.str* %0, %struct.builtin.str* %1) {
  %3 = alloca %num (%struct.builtin.str*, %struct.builtin.str*)*, align 8
  store %num (%struct.builtin.str*, %struct.builtin.str*)* @fn.user.count_char_occurrences, %num (%struct.builtin.str*, %struct.builtin.str*)** %3, align 8
...
define void @fn.user.abort(%struct.builtin.str* %0) {
  ...
  store %struct.builtin.str* @string.-3389732028997062709, %struct.builtin.str** %4, align 8
  %5 = load %struct.builtin.str*, %struct.builtin.str** %4, align 8
  %6 = alloca %struct.builtin.str*, align 8
  store %struct.builtin.str* @string.-1742558158085802614, %struct.builtin.str** %6, align 8
